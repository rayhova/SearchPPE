...
<?php if($hero_type == "image"): ?>
	<?php if ( have_rows( 'slider' ) ) : ?>
		...
		<section class="hero">
			<div id="hero-slide-<?php echo $row_index ?>" class="carousel slide" data-ride="">
				...
				<a class="carousel-control-prev" href="#hero-slide-<?php echo $row_index ?>" role="button" data-slide="prev">
			    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
			    <span class="sr-only">Previous</span>
			  </a>
			  <a class="carousel-control-next" href="#hero-slide-<?php echo $row_index ?>" role="button" data-slide="next">
		...
		jQuery(function($){
			$('#hero-slide-<?php echo $row_index ?>').carousel();
			});
		</script>
	<?php else : ?>
		<?php // no rows found ?>
